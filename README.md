...
<h1 align="center">CivicX</h1>

<p align="center"><strong>Turn local problems into visible action.</strong></p>
...
2. A legitimate map or geolocation service.
3. A user-uploaded file stored through secure storage.
4. An authorized status transition.
5. A transparent calculation over records that actually exist.
...
2. Add empty, loading, success, and error states for new data surfaces.
3. Avoid hardcoded complaint records, statistics, coordinates, or activity.
4. Use typed server procedures for database operations.
5. Keep authorization checks on the server.
6. Add or update tests for critical flows.
7. Keep user-facing copy concise, transparent, and free from unsupported institutional claims.
...
CivicX is a production-oriented civic technology project focused on transparent, location-aware community reporting for the NCR.

<p align="center"><img src="docs/civicx-logo.svg" alt="CivicX logo" width="96" /></p>

<p align="center"><strong>See a problem. Report it. Make your community heard.</strong></p>
